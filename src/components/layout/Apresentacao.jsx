    ...
    return (
        <>
            ...
            <div className={styles.apresentacao}>
                ...
                <div>
                    <h1 className={styles.h1_apresentacao}>O que é World of Darkness?</h1>
                    <p className={styles.p_apresentacao}> <br />Mundo das Trevas é o nome dado a dois universos ficcionais relacionados, mas distintos, criados como configurações de campanha para role-playing games de horror originalmente da editora estadunidense White Wolf. O primeiro foi concebido por Mark Rein-Hagen, enquanto o segundo foi projetado por várias pessoas da White Wolf Gaming Studio, que Rein-Hagen ajudou a criar.</p>
                </div>
            </div>

            <div className={styles.apresentacao}>
                <div>
                    <h1 className={styles.h1_apresentacao}>Sobre o Projeto</h1>
                    <p className={styles.p_apresentacao}> <br />O projeto foi criado pela junção de dois fatores, o estudo e o amor pelo RPG. O site foi projetado para fins de estudo na área da programação, e nada melhor do que estudar enquanto espalha seu hobby favorito. O objetivo do site é apresentar o universo de WoD para novos jogadores e os ensinar a jogar (ou servir de consulta para veteranos). </p>
                </div>
